            ...
            try {
                ...
                if (notificationAttributesJson != null) {
                    ...
                    if (notificationAttributes.getFireDate() < System.currentTimeMillis()) {
                        ...
                        Log.d("fatTAGJems", "onReceive: sendToNotificationCentre");
                        rnPushNotificationHelper.sendToNotificationCentre(notificationAttributes.toBundle()); //RNPushNotificationBootEventReceiver
                    } else {
