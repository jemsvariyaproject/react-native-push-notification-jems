...
public class RNPushNotificationHelper {
    ...
    public void sendNotificationScheduledCore(Bundle bundle) {
        ...
        Log.d(LOG_TAG, String.format("Setting a notification with id %s at time %s",bundle.getString("id"), Long.toString(fireDate)));
    ...
    public void sendToNotificationCentre(final Bundle bundle) {
      RNPushNotificationPicturesAggregator aggregator = new RNPushNotificationPicturesAggregator(new RNPushNotificationPicturesAggregator.Callback() {
          public void call(Bitmap thumb, Bitmap linkBitmap, Bitmap largeIconImage, Bitmap bigPictureImage, Bitmap bigLargeIconImage) {
              sendToNotificationCentreWithPicture(bundle, thumb, linkBitmap, largeIconImage, bigPictureImage, bigLargeIconImage);
        }
      });
      Log.d(LOG_TAG, "sendToNotificationCentre: bundle.getString(\"link\"):"+bundle.getString("link"));
      Log.d(LOG_TAG, "sendToNotificationCentre: bundle.getString(\"senderThumbnail\"):"+bundle.getString("senderThumbnail"));
      aggregator.setLinkUrl(context, bundle.getString("link"));
      aggregator.setThumbUrl(context, bundle.getString("senderThumbnail"));
    ...
    public void sendToNotificationCentreWithPicture(Bundle bundle, Bitmap thumb, Bitmap linkBitmap, Bitmap largeIconBitmap, Bitmap bigPictureBitmap, Bitmap bigLargeIconBitmap) {
        try {


            Log.d(LOG_TAG, "sendToNotificationCentreWithPicture: thumb:"+thumb);
            Log.d(LOG_TAG, "sendToNotificationCentreWithPicture: linkBitmap:"+linkBitmap);
            Log.d(LOG_TAG, "sendToNotificationCentreWithPicture: largeIconBitmap:"+largeIconBitmap);
            Log.d(LOG_TAG, "sendToNotificationCentreWithPicture: bigPictureBitmap:"+bigPictureBitmap);
            Log.d(LOG_TAG, "sendToNotificationCentreWithPicture: bigLargeIconBitmap:"+bigLargeIconBitmap);
            ...
            if (thumb == null && largeIconBitmap != null){
            ...
            Log.d(LOG_TAG, "sendToNotificationCentreWithPicture: notificationID:"+notificationID);
            ...
            if (!(this.isApplicationInForeground() && bundle.getBoolean("ignoreInForeground"))) {
                ...
                if (thumb != null) {
                    ...
                    expandedView.setImageViewBitmap(R.id.ic_thumb, thumb);

                    Bitmap appIcon = RNPushNotificationPicturesAggregator.getMagicalBitmap(context,R.drawable.notification_icon);
                    expandedView.setImageViewBitmap(R.id.ic_logo, appIcon); //Jems Just remember
                    expandedView.setTextViewText(R.id.title1, title);
                    expandedView.setTextViewText(R.id.title2, message);

                    if (linkBitmap != null) {
                        expandedView.setViewVisibility(R.id.notification_img, View.VISIBLE);
                        expandedView.setImageViewBitmap(R.id.notification_img, linkBitmap);
                        notification
                                //set Main View as Expanded View when we pass null then it will not showing...
                                .setCustomBigContentView(expandedView);
                    }


                    RemoteViews collapsedView = new RemoteViews(context.getPackageName(), R.layout.custom_collapse_notification);
                    collapsedView.setImageViewBitmap(R.id.ic_thumb, thumb);
                    collapsedView.setImageViewBitmap(R.id.ic_logo, appIcon);//Jems Just remember
                    collapsedView.setTextViewText(R.id.title1, title);
                    collapsedView.setTextViewText(R.id.title2, message);

                    //set Main View as Collapsed View
                ...
                Log.d(LOG_TAG, "sendToNotificationCentreWithPicture: ready for push ");
