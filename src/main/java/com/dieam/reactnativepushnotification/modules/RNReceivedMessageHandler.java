...
public class RNReceivedMessageHandler {
    ...
    public void handleReceivedMessage(RemoteMessage message) {
        ...
        Log.d(LOG_TAG, "handleReceivedMessage: ...called !!!");
        ...
        for(Map.Entry<String, String> entry : notificationData.entrySet()) {
            Log.i(LOG_TAG, "handleReceivedMessage: key:" + entry.getKey() + " >> value:" + entry.getValue());
            if (entry.getKey().equalsIgnoreCase("senderThumbnail")) {
                Log.d(LOG_TAG, "handleReceivedMessage: senderThumbnail set...................");
                bundle.putString("senderThumbnail", entry.getValue());
            }
            if (entry.getKey().equalsIgnoreCase("link")) {
                Log.d(LOG_TAG, "handleReceivedMessage: link set...................");
                bundle.putString("link", entry.getValue());
            }
            if (entry.getKey().equalsIgnoreCase("badge")) {
                badgeT =  entry.getValue();
            }
            dataBundle.putString(entry.getKey(), entry.getValue());
        }

        if(Integer.parseInt(badge) == Integer.parseInt(badgeT)){
            return;
        }
        badge = badgeT;

        Log.d(LOG_TAG, "handleReceivedMessage: badgeT:"+badgeT);
        Log.d(LOG_TAG, "handleReceivedMessage: badge:"+badge);
    ...
    private void handleRemotePushNotification(ReactApplicationContext context, Bundle bundle) {
        ...
        if (config.getNotificationForeground() || !isForeground) {
            ...
            Log.d("fatTAGJems", "handleRemotePushNotification: sendToNotificationCentre");
            pushNotificationHelper.sendToNotificationCentre(bundle); //handleRemotePushNotification
        }
    }
